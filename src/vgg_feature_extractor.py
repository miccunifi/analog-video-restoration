...
class VGGFeatureExtractor(nn.Module):
    ...
    def __init__(self, layer_name_list, use_input_norm=True, use_range_norm=False, requires_grad=False):
        """VGG-19 network for feature extraction.
        ...
        net = OrderedDict(zip(names, features))
